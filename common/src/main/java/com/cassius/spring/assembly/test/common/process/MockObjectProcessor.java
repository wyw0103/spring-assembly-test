...
import com.cassius.spring.assembly.test.common.setting.processor.MockObject;
...
/**
 * Created by Cassius Cai on 1/24/15 19:44.
 */
public class MockObjectProcessor extends AbstractExeProcessor {
    ...
    protected boolean needProcessBefore(Object instance, Field field) {
        return field.isAnnotationPresent(MockObject.class);
    }
