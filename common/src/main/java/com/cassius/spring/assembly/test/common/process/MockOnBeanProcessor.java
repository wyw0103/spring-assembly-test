...
import com.cassius.spring.assembly.test.common.setting.processor.MockOnBean;
...
/**
 * Created by Cassius Cai on 1/24/15 19:57.
 */
public class MockOnBeanProcessor extends AbstractPstProcessor {
    ...
    protected boolean needProcessBefore(Object instance, Field field) {
        return field.isAnnotationPresent(MockOnBean.class);
    }
